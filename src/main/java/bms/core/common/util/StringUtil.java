...
public class StringUtil {
	...
	public static String toCamelhumpStyle(String str, String seperator) {
		return StringUtil
				.underlineToCamelhump(toUnderlineStyle(str, seperator));
	}
	...
	public static String toDateFormat(Date time) {
	...
	public static String listToString(String join, List<String> list) {
		String[] auths = new String[list.size()];
		auths = list.toArray(auths);
		String result = join + String.join(join, auths) + join;
		return result;
	}

	public static String getReq(HttpServletRequest req, String name,
			String defaultValue) {
